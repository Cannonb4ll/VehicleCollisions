...
namespace VehicleCollisions.Scenes
{
    internal class CarDroveThroughRoadBlock : IScene
    {
        ...
        {
            new CrashedVehicle(new Vector3(RandomCoordinates.X, RandomCoordinates.Y, RandomCoordinates.Z), AccidentHeadings[AccidentIndex], VehicleUtilities.GetSafeRandomVehicle())
                ...
                {
                    new VehiclePed(new Vector3(RandomCoordinates.X, RandomCoordinates.Y, RandomCoordinates.Z), AccidentHeadings[AccidentIndex], PedUtilities.GetRandomPed(), VehicleSeat.Driver )
