...
namespace VehicleCollisions.Scenes
{
    internal class CarCrashWithBike :IScene
    {
        ...
        public Vector3 Coordinates => new Vector3(RandomCoordinates.X + rnd.Next(0,10), RandomCoordinates.Y + rnd.Next(0,10), RandomCoordinates.Z);
        public Vector3 BikeCoordinates => new Vector3(Coordinates.X + rnd.Next(1,10), Coordinates.Y + rnd.Next(1, 10), Coordinates.Z);
        ...
        {
            new CivilianPed(new Vector3(BikeCoordinates.X + rnd.Next(1, 5), BikeCoordinates.Y  + rnd.Next(1, 5), BikeCoordinates.Z), rnd.Next(0, 360), PedUtilities.GetRandomPed())
                .ShouldHaveBlip(true)
                .SetHealth(0), 
        };
