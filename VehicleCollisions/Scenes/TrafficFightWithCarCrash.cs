...
namespace VehicleCollisions.Scenes
{
    internal class TrafficFightWithCarCrash : IScene
    {
        ...
        public string Description => "We've received a call that a fight has occured and a car has crashed down a bridge.";
        ...
        public CrashedVehicle[] CrashedCars => new CrashedVehicle[]
        {
            new CrashedVehicle(new Vector3(50.63f, -781.75f, 43.44f), 251.22f, VehicleUtilities.GetSafeRandomVehicle())
                ...
                {
                    new VehiclePed(new Vector3(-50.51f, -781.37f, 44.17f), 224.48f, PedHash.Marine02SMY, VehicleSeat.Driver ), 
                }),
            ...
            new CrashedVehicle(new Vector3(78.99f, -792.29f, 31.24f), 74.6f, VehicleUtilities.GetSafeRandomVehicle())
                ...
                .SetPedsInVehicle(new VehiclePed[]
                {
                    new VehiclePed(new Vector3(-78.51f, -792.37f, 31.17f), 74.48f, PedHash.Marine02SMY, VehicleSeat.Driver )
                        .SetHealth(0), 
                }),
        };
