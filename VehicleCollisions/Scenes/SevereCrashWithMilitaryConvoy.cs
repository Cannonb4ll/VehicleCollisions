...
internal class SevereCrashWithMilitaryConvoy : IScene
    {
        ...
        public string Description => "We've received a call of a severe crash with a military convoy, 2 vehicles are involved.";
        ...
        public PoliceCar[] PoliceCars => new PoliceCar[] {
            new PoliceCar(new Vector3(-1777f, -655f, 10f), 290f, VehicleHash.Police)
                .SetSirenActive(true)
                .SetSirenSilent(true)
                .SetTrunkOpen(true),
        };
        ...
        public CrashedVehicle[] CrashedCars => new CrashedVehicle[]
        {
            new CrashedVehicle(new Vector3(-1759.75f, -674.46f, 10f), 355f, VehicleHash.Barracks3)
                ...
                {
                    new VehiclePed(new Vector3(-1766.51f, -677.37f, 10.17f), 250f, PedUtilities.GetRandomMilitary(), VehicleSeat.Driver )
                        .SetHealth(0), 
                }),
            new CrashedVehicle(new Vector3(-1762.76f, -673.35f, 10f), 257f, VehicleHash.Crusader)
                .SetRotation(new float[] { 0f, 90f, 0f })
                .ShouldHaveBlip(true)
                .SetEngineHealth(200)
                .ShouldBeDamaged(true)
                .SetPedsInVehicle(new VehiclePed[]
                {
                    new VehiclePed(new Vector3(-1762.51f, -673.37f, 10.17f), 250f, PedUtilities.GetRandomMilitary(), VehicleSeat.Driver )
                        .SetHealth(0), 
                }),
        ...
        public void Start(Ped[] CivilianPeds = null, Vehicle[] CrashedCars = null)
        {
            ...
            ShowSubtitle("[Officer] I am trying to block the road here for you, I have not evaluated the situation yet", 10000);
        }
