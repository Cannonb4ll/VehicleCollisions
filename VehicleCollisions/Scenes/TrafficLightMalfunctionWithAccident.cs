...
internal class TrafficLightMalfunctionWithAccident : IScene
    {
        ...
        public string Description => "We've received a call traffic lights has crashed on D. Rockford Hills crossing, a crash happened.";
        ...
        {
            new CrashedVehicle(new Vector3(-634.35f, -339.18f, 34.42f), 344.37f, VehicleUtilities.GetSafeRandomVehicle())
                .SetPedsInVehicle(new VehiclePed[]
                {
                    new VehiclePed(new Vector3(-630.51f, -342.37f, 34.17f), 350.48f, PedUtilities.GetRandomPed(), VehicleSeat.Driver ), 
                })
                .ShouldRandomlyBeDamaged(true)
                .SetBlinkingLights(true)
                .SetEngineHealth(rnd.Next(-50, 100))
                .ShouldHaveBlip(true),
            new CrashedVehicle(new Vector3(-637.04f, -336.79f, 34.72f), 232.38f, VehicleUtilities.GetSafeRandomVehicle())
                .SetPedsInVehicle(new VehiclePed[]
                {
                    new VehiclePed(new Vector3(-627.51f, -346.37f, 34.17f), 34.48f, PedUtilities.GetRandomPed(), VehicleSeat.Driver ), 
                })
                .ShouldRandomlyBeDamaged(true)
            ...
            new CrashedVehicle(new Vector3(-632.7f, -343.53f, 34.48f), 26.27f, VehicleUtilities.GetSafeRandomVehicle())
                .SetPedsInVehicle(new VehiclePed[]
                {
                    new VehiclePed(new Vector3(-633.51f, -339.37f, 34.17f), 238.48f, PedUtilities.GetRandomPed(), VehicleSeat.Driver )
                        .SetHealth(0), 
                })
                .ShouldRandomlyBeDamaged(true)
